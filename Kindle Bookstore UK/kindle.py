...
def getData(asin):
    ...
    requestDict = encodeRequestList(requestList, "Images,Small")
    itemRequest = PyAl.Request("http://webservices.amazon.co.uk/onca/xml", requestDict)
    ...
    try:
        ...
        link = "http://www.amazon.co.uk/dp/%s" % asin
    try:
...
def doSearch():
    ...
    searchRequest = PyAl.Request("http://webservices.amazon.co.uk/onca/xml", requestDict)
